...
public class ListaLeituraController {
     ...
     @PostMapping("/usuarios/{usuarioId}/leitura")
     public ResponseEntity<?> adicionar(@PathVariable Long usuarioId, @RequestBody @Valid DadosNovaLeitura dados) {
          return ResponseEntity.ok(leituraService.adicionarLivroALista(usuarioId, dados));
     }
